                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="w-full py-7">
                        ...
                        <div className="w-full mt-3 inline-flex flex-col justify-center">
                            ...
                            <SocialIcon name="LinkedIn" href="https://www.linkedin.com/in/vardrz">
                                <svg
                            ...
                            <SocialIcon name="WhatsApp" href="http://wa.me/6289525196861">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-4 w-4"
                                    fill="currentColor"
                            ...
                            <SocialIcon name="Instagram" href="http://instagram.com/vard.rz">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-4 w-4"
                                    fill="currentColor"
