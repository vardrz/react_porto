        ...
        <div className="w-full pt-32 px-10 text-light">
...

            {
                projects != null
                            ...
                            <div className="flex flex-col md:w-3/4 justify-center">
                                ...
                                <div className="flex mt-3">
                                    ...
                                    </div>
                                    {
                                        item.link != '-'
                                            ? (
                                                <a href={item.link} target="blank" className="text-light w-fit flex flex-row items-center hover:text-secondary">
                    ...
                    : (
                        <div className="text-3xl text-primary w-full inline-flex justify-center">Load Projects ..</div>
                    )
            }
        </div>
    )
