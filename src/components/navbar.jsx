        ...
        if(hash == '' || hash == '#/'){
            return (
                <div className="flex items-center justify-center w-10 sm:w-[52px] rounded-full p-[0.5px] border-2 border-primary/30">
                    {
                        avatarLoad ?
                            <div className="flex items-center justify-center w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-dark2 animate-pulse">
                    ...
                    <img src={avatar} className="w-9 h-9 sm:w-11 sm:h-11 rounded-full object-cover" alt="Farid" onLoad={() => setAvatarLoad(false)}/>
                </div>
            )
        }else{
            return (
