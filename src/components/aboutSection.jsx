            ...
            <div className="w-full px-6 md:px-10 max-w-6xl mx-auto pt-24">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="w-full py-7 md:pl-10">
                        <p className="text-light/75 text-center md:text-left leading-relaxed text-lg md:text-xl whitespace-pre-wrap">
...
I mostly work on the front-end using React & Flutter, and the back-end with Laravel.`}
                        ...
                        <div className="w-full mt-8 inline-flex flex-row justify-center md:justify-start">
                            <SocialIcon href={profil?.github ?? "http://github.com/vardrz"} className="mr-5">
                                <svg
                            ...
                            <SocialIcon href={`mailto:${profil?.email ?? "fatkhurrozakf@gmail.com"}`} className="mr-5">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-6 w-6"
                                    fill="currentColor"
